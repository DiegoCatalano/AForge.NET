...
namespace AForge.Math
{
    ...
    public struct Complex : ICloneable, ISerializable
    {
        ...
        /// <summary>
        /// Return an array of real part from complex vector.
        /// </summary>
        /// <param name="z">Complex vector.</param>
        /// <returns>Real part.</returns>
        public static double[] Real(Complex[] z)
        {
            double[] real = new double[z.GetLength(0)];
        ...
        /// <summary>
        /// Return a matrix of real part from complex matrix.
        /// </summary>
        /// <param name="z">Complex matrix.</param>
        /// <returns>Real part.</returns>
        public static double[,] Real(Complex[,] z)
        {
            double[,] real = new double[z.GetLength(0), z.GetLength(1)];
            for (int i = 0; i < real.GetLength(0); i++)
            {
        ...
        /// <summary>
        /// Return an array of imaginary part from complex vector.
        /// </summary>
        /// <param name="z">Complex vector.</param>
        /// <returns>Imaginary part.</returns>
        public static double[] Imaginary(Complex[] z)
        {
            double[] imaginary = new double[z.GetLength(0)];
            for (int i = 0; i < imaginary.GetLength(0); i++)
            {
                imaginary[i] = z[i].Im;
            }
            return imaginary;
        ...
        /// <summary>
        /// Return a matrix of imaginary part from complex matrix.
        /// </summary>
        /// <param name="z">Complex matrix.</param>
        /// <returns>Imaginary part.</returns>
        public static double[,] Imaginary(Complex[,] z)
        {
            double[,] imaginary = new double[z.GetLength(0), z.GetLength(1)];
            for (int i = 0; i < imaginary.GetLength(0); i++)
            {
                for (int j = 0; j < imaginary.GetLength(1); j++)
                {
                    imaginary[i, j] = z[i, j].Im;
                }
            }
            return imaginary;
        }
